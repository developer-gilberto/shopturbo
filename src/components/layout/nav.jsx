...
export function Nav() {
    ...
    const { pageSizeShopee, setHasPreviousPage, setHasNextPageShopturbo, setHasNextPageShopee, setCurrentPage } = useProductPagination();
    ...
    return (
        <nav className="border border-[--bg_4] min-w-fit p-2">
            <ul className="flex flex-col gap-4 p-2">
                <li id="dashboardId" onClick={handleClickTab} className="flex rounded-md">
                    <Link
                        href="/dashboard"
                ...
                <li className="flex rounded-md">
                    <button
                        ...
                        className="min-w-full bg-[--bg_4] py-1 px-2 rounded-md border-[1px] border-transparent text-left hover:bg-[--bg_5] hover:border-[--bg_3] hover:cursor-pointer"
                    >
                        Produtos
                    </button>
                </li>
                ...
                <li className="relative flex rounded-md">
                    <span className={`${!shop ? 'absolute top-0 right-0 h-4 w-4 animate-ping rounded-full bg-[--primary_color] opacity-75' : 'hidden'}`}></span>
                    <Link
