...
export function EditCostPriceSearchButton({ editedProductId, fromShopturbo }) {
  ...
  function handleInputCostPrice() {
    const inputCostPrice = prompt(
      "Digite o preço de custo - para números com vírgula, digite ponto no lugar da vírgula: ".toUpperCase(),
      "2.99",
    );
    ...
    if (inputCostPrice.trim() === "") {
      alert("⚠️ Você não digitou nada!".toUpperCase());
      return;
    }
    ...
    const inputTaxes = prompt(
      "Digite o valor do imposto % -> Exemplo: 3.5 ",
      "1.5",
    );
