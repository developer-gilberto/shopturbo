                ...
                <div className="w-[720px] min-h-screen flex flex-col justify-center items-center gap-6 m-auto">
                    {shop?.expire_time && (
                        <div className="text-xl mb-4">
                            <p>
                                O ShopTurbo já está conectado à sua loja Shopee.
                            </p>
                            <p>
                                A autorização é válida exatamente até:{' '}
                                <span className="text-[--primary_color]">
                                    {new Date(
                                        Number(shop.expire_time) * 1000,
                                    ).toLocaleDateString('pt-BR')}
                                </span>
                                .{' '}
                            </p>
                            <p>
                                Depois dessa data você tem que autorizar o
                                ShopTurbo novamente clicando no botão{' '}
                                <span className="text-[--primary_color]">
                            ...
                            <p>
                                Caso queira renovar a autorização antes de
                                expirar, basta clicar no mesmo botão.
                            </p>
                        </div>
                    )}
